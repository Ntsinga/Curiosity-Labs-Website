  ...
  "@graph": [
    {
      ...
      contactPoint: {
        ...
        email: "hello@curiositylabs.tech",
      },
      sameAs: [],
    },
    {
      ...
      url: BASE_URL,
      name: "Curiosity Labs",
      alternateName: "Curiosity Labs | African Technology & Innovation Hub",
      description:
    ...
    },
    {
      ...
      "@id": `${BASE_URL}/#webpage`,
      url: BASE_URL,
      name: "Curiosity Labs | African Technology & Innovation Hub",
        ...
        <section className="flex flex-col items-center justify-center min-h-screen px-6 pt-28 pb-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center gap-8">
            ...
            <p className="max-w-2xl text-lg md:text-xl text-zinc-400 leading-relaxed">
              A technology hub driven by curiosity, building solutions that
              solve Africa&apos;s problems — one question at a time.
            </p>
            <a
              href="#about"
        ...
        <section id="about" className="py-24 px-6 border-t border-white/5">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-zinc-300 text-lg leading-relaxed">
              <p>
                Curiosity — this urge, this itch, this feeling — has driven us
                for most of our lives. The curiosity to learn, to know. It led
                us from science to technology, where we discovered that
                technology is curiosity&apos;s questions answered in physical
                form with the help of science.
              </p>
              <p>
                Technology, like any innovation at its core, is the attempt to
                solve a problem. We&apos;re not just asking any questions in
                this endless sea of curiosity — we&apos;re asking questions that
                solve our people&apos;s problems.
              </p>
              <p>
                Here at Curiosity Labs, we aim to be a hub of curiosity, of
                questions, of ideas, of possibilities. Questions that aim to
                solve Africa&apos;s problems — problems we plan to solve with
                technology.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-zinc-400">
                © {new Date().getFullYear()} Curiosity Labs. All rights
                reserved.
              </span>
            </div>
